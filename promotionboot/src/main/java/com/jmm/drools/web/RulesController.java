...
import com.jmm.drools.bean.Indicator;
...
import com.jmm.drools.service.RuleTableService;
...
//            @ApiImplicitParam(name = "name", dataType = "String", required = true, value = "规则名称")})
    ...
    public JsonResponse ruleAdd(@RequestParam("rule") String rule, @RequestParam("name") String name) {
    ...
    private final static String verify="规则：package com.jmm.drools;\n" +
            "import com.jmm.drools.bean.Person;\n" +
            "rule \"2\"\n" +
            "\twhen\n" +
            "        $p : Person(age < 30);\n" +
